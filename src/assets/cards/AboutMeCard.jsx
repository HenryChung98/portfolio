...
export default function AboutMeCard() {
  return (
    <>
      ...
      <p className="mb-4">
        I am currently pursuing a Computing Science diploma at Douglas College,
        with a deep passion for game and web development.
      </p>
      <p className="mb-4">
        ...
        Engine. My expertise lies in designing game mechanics and
        building intuitive user interfaces.
      </p>
      <p className="mb-4">
        I also have a solid understanding of foundational web technologies and
        experience with frameworks such as Next.js, Tailwind CSS for styling, as
        well as backend services like Supabase. Currently, I am working on a CRM
        project that helps small businesses manage customers and sales more
        efficiently.
      </p>
      <p className="mb-4">
        Outside of programming, I participate in dance performances and drop-in
        sessions with my school club, which enhance my creativity and
